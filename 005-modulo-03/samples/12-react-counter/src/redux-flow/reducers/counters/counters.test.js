...
it('Should increment an outher counter', () => {
...
it('Should decrement an outher counter', () => {
...
it('Should return same state if actionis unknow', () => {
...
it('Should return initialstate if last state undefined', () => {
