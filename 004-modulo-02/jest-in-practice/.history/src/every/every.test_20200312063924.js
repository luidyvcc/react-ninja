...
it('every([], item => item', () => {
  expect(every([], item => item)).to.be.ok; // boolean test
})

it('every([0, 2, 3], item => item) should return false', () => {
  expect(every([0, 2, 3], item => item)).to.not.be.ok; // boolean test
})

it('every([1, 2, 3], item => item > 2) should return false', () => {
  expect(every([1, 2, 3], item => item > 2)).to.not.be.ok; // boolean test
})
