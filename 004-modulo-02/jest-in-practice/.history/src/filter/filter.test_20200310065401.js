...
it('filter([1, 2, 3], (item, index) => item === index + 1) should return [1, 2, 3]', () => {
  expect(filter([1, 2, 3], (item, index) => item === index + 1)).to.be.deep.equal([1, 2, 3]);
})

it('filter([1, 2, 3, 2, 1, 5], (item, index, array) => index === array.indexOf(item)) should return [1, 2, 3]', () => {
  expect(filter([1, 2, 3, 2, 1, 5], (item, index, array) => index === array.indexOf(item))).to.be.deep.equal([1, 2, 3]);
})