...
it('some([1, 2, 3], (item, index) => index % 2 === 0', () => {
  expect(some([1, 2, 3], (item, index) => index % 2 === 0)).to.be.ok; // boolean test
})

it('some([1, 5, 3], (item, index) => index % 2 === 0', () => {
  expect(some([1, 5, 3], (item, index) => index % 2 === 0)).to.not.be.ok; // boolean test
})
